...
```{r}
file_url <- "https://www.insee.fr/fr/statistiques/serie/telecharger/csv/010768319?ordre=antechronologique&transposition=donneescolonne&periodeDebut=1&anneeDebut=1990&periodeFin=2&anneeFin=2024&revision=sansrevisions"
...
```{r}
diff_series_1 <- diff(raw_series, 1)
plot(diff_series_1, main = "1-differenciated series", xlab = "Date", ylab = "Value")

diff_series_12 <- diff(raw_series, 12)
plot(diff_series_12, main = "12-differenciated series", xlab = "Date", ylab = "Value")
```
