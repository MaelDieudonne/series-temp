...
L'expression générale de la variance est la suivante. Pour l'appliquer, on pose $$ar_0 = 1$$ et on néglige les termes connus plutôt que prédits lorsque l'horizon $$h$$ est inférieur à 11.
